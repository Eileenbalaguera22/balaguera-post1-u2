...
/**
 * Configuracion de una exportacion concreta.
 * Un solo parametro es obligatorio (format);
 * los demas son opcionales con valores por defecto.
 */
public class ExportConfig {
    ...
    public static class Builder {
        ...
        public ExportConfig build() {
            ...
            if (maxRowsPerPage <= 0) {
                throw new IllegalStateException(
                    "maxRowsPerPage debe ser mayor que 0"
                );
            }
